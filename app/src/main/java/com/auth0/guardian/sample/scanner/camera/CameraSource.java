...
import com.auth0.guardian.sample.scanner.utils.Frame;
 ...
 * {@link com.auth0.guardian.sample.scanner.utils.Detector}.  This receives preview frames from the camera at
...
public class CameraSource {
    ...
    private Camera createCamera() {
        ...
        Log.d(TAG, String.format("setPreviewSize to %dx%d", mPreviewSize.getWidth(), mPreviewSize.getHeight()));
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        @SuppressLint("Assert")
        void release() {
            // App closes because the processingThread is null
            // Ensure not null
            // Internals of mDetector.release() also check for a not null
            assert (
                mProcessingThread == null ||
                mProcessingThread.getState() == State.TERMINATED
            );
            mDetector.release();
            mDetector = null;
        }
